...
describe('ProjectTemplate Management Component', () => {
  let comp: ProjectTemplateComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'project-template', component: ProjectTemplateComponent }]),
      ...
      .overrideTemplate(ProjectTemplateComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectTemplates?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
