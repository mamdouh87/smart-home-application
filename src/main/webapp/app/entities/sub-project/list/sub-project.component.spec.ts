...
describe('SubProject Management Component', () => {
  let comp: SubProjectComponent;
  let fixture: ComponentFixture<SubProjectComponent>;
  let service: SubProjectService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sub-project', component: SubProjectComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SubProjectComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.subProjects?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
