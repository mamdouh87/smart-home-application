...
describe('BuildingType Management Component', () => {
  let comp: BuildingTypeComponent;
  let fixture: ComponentFixture<BuildingTypeComponent>;
  let service: BuildingTypeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'building-type', component: BuildingTypeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BuildingTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.buildingTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
